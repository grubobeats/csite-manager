                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('weather', ['1' => trans('forms.select-sunny'), '2' => trans('forms.select-dust'), '3' => trans('forms.select-rainy'), '4' => trans('forms.select-snowing') ], null, ['class'=>'form-control']) }}
                            </div>
