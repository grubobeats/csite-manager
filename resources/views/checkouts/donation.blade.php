        ...
        <div class="col-sm-offset-3 col-sm-6">
            <div class="checkout">
                ...
                <form action="{{ route('post.checkout') }}" method="post" id="payment-form" class="form" autocomplete="off" novalidate>
                    ...
                    <input type="hidden" id="card-number-clean" data-stripe="number" value="">
                    <fieldset>
                    ...
                    <fieldset class="fieldset-expiration">
                        ...
                        <div class="select">
                            <select id="card-expiration-month" data-stripe="exp_month">
                                <option></option>
                                <option>01</option>
                                <option>02</option>
                                <option>03</option>
                        ...
                        <div class="select">
                            <select id="card-expiration-year" data-stripe="exp_year">
                                <option></option>
                                <option>2016</option>
                                <option>2017</option>
                                <option>2018</option>
