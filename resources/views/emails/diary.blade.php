...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#f9f9f9" style="border-bottom: 1px solid darkgray">
    <tr>
        <td></td>
        <td class="header container">
            ...
            <div class="content">
                <table bgcolor="#f9f9f9">
                    <tr>
                        <td> </td>
                        <td align="left"><h6 class="collapse">Construction Manager</h6></td>
                    </tr>
                </table>
            </div>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <h3>{{ $csite->name }} <small>{{ $csite->city }}</small></h3>
